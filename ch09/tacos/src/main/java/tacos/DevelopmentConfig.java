...
public class DevelopmentConfig {
    ...
    public CommandLineRunner dataLoader(IngredientRepository ingredientRepository, UserRepository userRepository,
        ...
        return args -> {
            ...
            User savedUser = userRepository.save(new User("1", encoder.encode("1"),
                    "Dmitriy", "Vertoletnaya", "Lubertcy", "Moscow", "140013",
                    "8999000998","kokotovdv@gmail.com"));

            paymentMethodRepository.save(new PaymentMethod(savedUser,
                    "4111111111111111", "321", "11/12"));
